...
# ============================================================
RUTA_CSV = os.path.join(os.path.dirname(__file__), "data", "flight_delays_15_aerolineas.csv")


@st.cache_resource(show_spinner="🤖 Entrenando el modelo de IA y construyendo el grafo de rutas...")
def preparar_sistema():
    ...
    if not os.path.exists(RUTA_CSV):
        raise FileNotFoundError(
            ...
            "Sube 'flight_delays_15_aerolineas.csv' a la carpeta data/ del repositorio."
        )
